...
import org.clulab.habitus.scraper.domains.BaophapluatDomain
...
class BaophapluatArticleScraper extends PageArticleScraper(BaophapluatDomain){
  ...
  def scrape(browser: Browser, page: Page, html: String): ArticleScrape = {
    ...
    val bylineOpt = (doc >> elementList("div.article__author div.author")).headOption.map(_.text)
